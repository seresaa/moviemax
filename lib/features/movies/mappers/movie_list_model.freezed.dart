...
class _$_MovieListModel implements _MovieListModel {
  ...
  @override
  String toString() {
    return 'MovieListModel(adult: $adult, backdrop_path: $backdrop_path, belongsToCollection: $belongsToCollection, budget: $budget, genres: $genres, homepage: $homepage, id: $id, imdbId: $imdbId, originCountry: $originCountry, originalLanguage: $originalLanguage, originalTitle: $originalTitle, overview: $overview, popularity: $popularity, poster_path: $poster_path, productionCompanies: $productionCompanies, productionCountries: $productionCountries, release_date: $release_date, revenue: $revenue, runtime: $runtime, spokenLanguages: $spokenLanguages, status: $status, tagline: $tagline, title: $title, video: $video, vote_average: $vote_average, voteCount: $voteCount)';
  }
...
abstract class _MovieListModel implements MovieListModel {
  const factory _MovieListModel(
      ...
      final bool? video,
      final double? vote_average,
      final int? voteCount}) = _$_MovieListModel;
